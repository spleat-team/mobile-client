...
//   List<Dish> dishes = Receipt.buildDishesFromJson(c["dishes"]);
//   Receipt r = Receipt(dishes, c["pincode"], c["numOfPeople"],
//       double.parse(c["price"].toString()));
//   return r;
// }

Future<DocumentSnapshot> getReceiptFromFirebase(String pincode) {
  return Firestore.instance.collection('receipts').document(pincode).get();
}
